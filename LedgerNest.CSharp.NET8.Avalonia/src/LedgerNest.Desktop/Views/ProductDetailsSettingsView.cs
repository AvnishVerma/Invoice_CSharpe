...
public partial class MainWindow
{
    ...
    private Control ProductDetailsSettingsView()
    {
        ...
        var fields = Ui.Stack(8,
            Ui.Text("Choose which fields appear on the product add/edit forms, the product list, and invoice line items. Name and Price are always required.", 14, color: Ui.Muted),
            ...
            new Border { Padding = new Thickness(0, 12, 0, 0), Child = Ui.Text("Product fields", 14, true) },
        ...
        save.Background = Ui.HeaderBand; save.MinHeight = 32; save.Height = 32; save.Padding = new Thickness(8, 6);
        ...
        var rail = new Border { Background = Ui.Surface, BorderBrush = Ui.Outline, BorderThickness = new Thickness(0, 0, 1, 0),
            Child = Ui.Rows("*,Auto", new Border(), new Border { Padding = new Thickness(16), Child = save }) };
