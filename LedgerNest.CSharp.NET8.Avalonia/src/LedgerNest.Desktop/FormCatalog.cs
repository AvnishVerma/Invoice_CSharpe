...
public static class FormCatalog
{
    ...
    public static Dictionary<string, FormSection[]> Settings() => new()
    {
        ...
        ["PDF Settings"] = [
            ...
            new("PRINTING", [Choice("Printer", PlatformPrinterService.GetPrinterChoices()), Toggle("Show Printer Selection Dialog", false, "Allow choosing a printer for every print job")])],
        ["Product Details"] = [
